            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-outline-variant">
                  <tr className="hover:bg-surface-container-low transition-colors"><td className="px-4 py-3 text-mono-data text-primary">INC-2041</td><td className="px-4 py-3">Flash Flooding: Central</td><td className="px-4 py-3"><span className="bg-error text-on-error text-label-caps px-2 py-0.5 rounded">CRITICAL</span></td><td className="px-4 py-3 text-body-sm">Konkan Coastal</td><td className="px-4 py-3 text-body-sm font-bold text-error">Active</td><td className="px-4 py-3 text-mono-data">2 min ago</td></tr>
                  <tr className="hover:bg-surface-container-low transition-colors"><td className="px-4 py-3 text-mono-data text-primary">INC-2040</td><td className="px-4 py-3">Power Grid Instability</td><td className="px-4 py-3"><span className="bg-tertiary-container text-on-tertiary-container text-label-caps px-2 py-0.5 rounded">HIGH</span></td><td className="px-4 py-3 text-body-sm">Mumbai Metro</td><td className="px-4 py-3 text-body-sm font-bold text-tertiary">Monitoring</td><td className="px-4 py-3 text-mono-data">14 min ago</td></tr>
                  <tr className="hover:bg-surface-container-low transition-colors"><td className="px-4 py-3 text-mono-data text-primary">INC-2039</td><td className="px-4 py-3">Road Closure: NH-48</td><td className="px-4 py-3"><span className="bg-surface-container-high text-on-surface-variant text-label-caps px-2 py-0.5 rounded">MEDIUM</span></td><td className="px-4 py-3 text-body-sm">Western Ghats</td><td className="px-4 py-3 text-body-sm font-bold text-primary">Ongoing</td><td className="px-4 py-3 text-mono-data">28 min ago</td></tr>
                </tbody>
              </table>
            </div>
          </div>
